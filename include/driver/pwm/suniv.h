...
#define SUNIV_PWM_CTRL_CH1_PRESCAL  BIT_RANGE(15, 18)   /* PWM Channel 1 Pre-scalar */
...
#define SUNIV_PWM_CTRL_CH0_PRESCAL  BIT_RANGE(0, 3)     /* PWM Channel 0 Pre-scalar */

#define SUNIV_PWM_CH0_ENTIRE_CYS    BIT_RANGE(16, 31)   /* Number of the entire cycles (24M/n) */
#define SUNIV_PWM_CH0_ACT_CYS       BIT_RANGE(0, 15)    /* Number of the active cycles (24M/n) */

#define SUNIV_PWM_CH1_ENTIRE_CYS    BIT_RANGE(16, 31)   /* Number of the entire cycles (24M/n) */
#define SUNIV_PWM_CH1_ACT_CYS       BIT_RANGE(0, 15)    /* Number of the active cycles (24M/n) */
