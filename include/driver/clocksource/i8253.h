...
#define NMISC_NMI_SERR_STAT         (1<<7)  // SERR# NMI Source Status
#define NMISC_NMI_IOCHK_STAT        (1<<6)  // IOCHK# NMI Source Status
#define NMISC_SPEAKER_STAT          (1<<5)  // Timer Counter 2 OUT Status
#define NMISC_REFRESH_TOGGLE        (1<<4)  // Refresh Cycle Toggle
#define NMISC_NMI_IOCHK             (1<<3)  // IOCHK# NMI Enable
#define NMISC_PCI_SERR              (1<<2)  // PCI SERR# Enable
#define NMISC_SPEAKER_EN            (1<<1)  // Speaker Data Enable
#define NMISC_TIMER2_EN             (1<<0)  // Timer Counter 2 Enable
