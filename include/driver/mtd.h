...
struct mtd_ops {
    state (*read)(struct mtd_device *, loff_t pos, void *buf, uint64_t len, uint64_t *retlen);
    state (*write)(struct mtd_device *, loff_t pos, void *buf, uint64_t len, uint64_t *retlen);
    state (*erase)(struct mtd_device *, loff_t pos, uint64_t len, uint64_t *retlen);
