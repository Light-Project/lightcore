...
enum ata_registers {
    ATA_REG_DATA        = 0x00, /* (RW) Read/Write PIO data bytes */
    ...
    ATA_REG_IRQ         = 0x02, /* (RW)     */
    ATA_REG_LBAL        = 0x03, /* (RW)     */
    ATA_REG_LBAM        = 0x04, /* (RW)     */
    ATA_REG_BYTEL       = 0x04, /* (RW)     */
    ATA_REG_LBAH        = 0x05, /* (RW)     */
    ATA_REG_BYTEH		= 0x05, /* (RW)     */
    ATA_REG_DEVICE      = 0x06, /* (RW)     */
...
#define ATA_ERR_BBK         BIT(7)
#define ATA_ERR_UNC         BIT(6)
#define ATA_ERR_MC          BIT(5)
#define ATA_ERR_IDNF        BIT(4)
#define ATA_ERR_MCR         BIT(3)
#define ATA_ERR_ABRT        BIT(2)
#define ATA_ERR_TKZNF       BIT(1)
#define ATA_ERR_AMNF        BIT(0)
