...
enum gpio_channel_flags {
    ...
    GPIOC_ACTIVE_LOW    = BIT(__GPIOC_ACTIVE_LOW),
    GPIOC_SOFT_DRAIN    = BIT(__GPIOC_SOFT_DRAIN),
    GPIOC_SOFT_SOURCE   = BIT(__GPIOC_SOFT_SOURCE),
    GPIOC_TRANSITORY    = BIT(__GPIOC_TRANSITORY),
    GPIOC_IS_HOGGED     = BIT(__GPIOC_IS_HOGGED),
};
