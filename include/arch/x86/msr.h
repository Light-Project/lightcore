...
#define EFER_SCE BIT(_EFER_SCE)
#define EFER_LME BIT(_EFER_LME)
#define EFER_LMA BIT(_EFER_LMA)
#define EFER_NX BIT(_EFER_NX)
#define EFER_SVME BIT(_EFER_SVME)
#define EFER_LMSLE BIT(_EFER_LMSLE)
#define EFER_FFXSR BIT(_EFER_FFXSR)
...
/* CPUID.6.EAX */
#define HWP_BASE_BIT BIT(7)
#define HWP_NOTIFICATIONS_BIT BIT(8)
#define HWP_ACTIVITY_WINDOW_BIT BIT(9)
#define HWP_ENERGY_PERF_PREFERENCE_BIT BIT(10)
#define HWP_PACKAGE_LEVEL_REQUEST_BIT BIT(11)
...
#define FAM10H_MMIO_CONF_ENABLE BIT(0)
...
#define MSR_IA32_APICBASE_BSP BIT(8)
#define MSR_IA32_APICBASE_ENABLE BIT(11)
...
#define PACKAGE_THERM_INT_HFI_ENABLE BIT(25)
