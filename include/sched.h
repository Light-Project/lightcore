...
enum sched_task_state {
    __SCHED_TASK_INTERRUPTIBLE = 0,
    __SCHED_TASK_UNINTERRUPTIBLE,
    __SCHED_TASK_NEW,
    __SCHED_TASK_STOPPED,
    __SCHED_TASK_KILL,

    SCHED_TASK_RUNNING          = 0,
    SCHED_TASK_INTERRUPTIBLE    = BIT(__SCHED_TASK_INTERRUPTIBLE),
    SCHED_TASK_UNINTERRUPTIBLE  = BIT(__SCHED_TASK_UNINTERRUPTIBLE),
    SCHED_TASK_NEW              = BIT(__SCHED_TASK_NEW),
    SCHED_TASK_STOPPED          = BIT(__SCHED_TASK_STOPPED),
    SCHED_TASK_KILL             = BIT(__SCHED_TASK_KILL),
    SCHED_TASK_BLOCKED          = SCHED_TASK_INTERRUPTIBLE | SCHED_TASK_UNINTERRUPTIBLE,
};
...
enum sched_task_exit {
    ...
    SCHED_TASK_DEAD     = BIT(__SCHED_TASK_DEAD),
    SCHED_TASK_ZOMBIE   = BIT(__SCHED_TASK_ZOMBIE),
};

enum sched_task_flags {
    __SCHED_TASK_KTHREAD = 0,
    __SCHED_TASK_KCORO,
    __SCHED_TASK_IDLE,
    __SCHED_TASK_NRESCHED,
    __SCHED_TASK_SIGNAL,

    SCHED_TASK_KTHREAD      = BIT(__SCHED_TASK_KTHREAD),
    SCHED_TASK_KCORO        = BIT(__SCHED_TASK_KCORO),
    SCHED_TASK_IDLE         = BIT(__SCHED_TASK_IDLE),
    SCHED_TASK_NRESCHED     = BIT(__SCHED_TASK_NRESCHED),
    SCHED_TASK_SIGNAL       = BIT(__SCHED_TASK_SIGNAL),
};

enum sched_task_queued {
    __SCHED_TASK_QUEUED = 0,
    __SCHED_TASK_MIGRATING,

    SCHED_TASK_QUEUED       = BIT(__SCHED_TASK_QUEUED),
    SCHED_TASK_MIGRATING    = BIT(__SCHED_TASK_MIGRATING),
};

enum sched_queue_flags {
    __SCHED_QUEUE_SAVE = 0,
    __SCHED_QUEUE_MOVE,
    ...
    SCHED_QUEUE_SAVE        = BIT(__SCHED_QUEUE_SAVE),
    SCHED_QUEUE_MOVE        = BIT(__SCHED_QUEUE_MOVE),
    SCHED_QUEUE_NOCLOCK     = BIT(__SCHED_QUEUE_NOCLOCK),
    SCHED_ENQUEUE_HEAD      = BIT(__SCHED_ENQUEUE_HEAD),
    SCHED_ENQUEUE_WEAKUP    = BIT(__SCHED_ENQUEUE_WEAKUP),
    SCHED_DEQUEUE_SLEEP     = BIT(__SCHED_DEQUEUE_SLEEP),
};
