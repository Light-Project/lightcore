...
# define NORMAL_LOWER   (CONFIG_RAM_PAD + CONFIG_DMA_SIZE)
# define NORMAL_OFFSET  (CONFIG_RAM_BASE + NORMAL_LOWER)
#else
# define NORMAL_LOWER   (CONFIG_RAM_PAD)
# define NORMAL_OFFSET  (CONFIG_RAM_BASE + NORMAL_LOWER)
#endif
...
#else
# define va_to_pa(va) ((phys_addr_t)((size_t)(va) - CONFIG_PAGE_OFFSET + CONFIG_RAM_BASE))
# define pa_to_va(pa) ((void *)((size_t)(pa) - CONFIG_RAM_BASE + CONFIG_PAGE_OFFSET))
#endif
...
#else
# define io_to_pa(va) ((phys_addr_t)((size_t)(va) - CONFIG_IOREMAP_OFFSET + CONFIG_RAM_BASE))
# define pa_to_io(pa) ((void *)((size_t)(pa) - CONFIG_RAM_BASE + CONFIG_IOREMAP_OFFSET))
#endif
